...
(function(){
            ...
            function countemwords(){
              ...
              counteroutput.innerHTML = 'Λέξεις: <span class="outputval">' + words + '</span> Χαρακτήρες: <span class="outputval">' + chars + '</span>'
              counteroutputFoot.innerHTML = '<b>Λέξεις: </b>' + words + '<b>Χαρακτήρες: </b>' + chars
            }
